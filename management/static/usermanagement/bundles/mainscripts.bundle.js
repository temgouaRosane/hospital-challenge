  ...
  ($.AdminSwift.leftSideBar = {
    activate: function () {
      ...
      $(window).click(function (e) {
        var i = $(e.target);
        "i" === e.target.nodeName.toLowerCase() && (i = $(e.target).parent()),
          !i.hasClass("bars") &&
            t.isOpen() &&
        ...
        $(".menu-toggle").on("click", function (e) {
          ...
          if ($(i.parents("ul")[0]).hasClass("list")) {
            ...
            $.each($(".menu-toggle.toggled").not(a).next(), function (e, i) {
              $(i).is(":visible") &&
                ($(i).prev().toggleClass("toggled"), $(i).slideUp());
            });
          }
      ...
      $(window).click(function (e) {
        ...
        "i" === e.target.nodeName.toLowerCase() && (i = $(e.target).parent()),
          !i.hasClass("js-right-sidebar") &&
            ...
            (i.hasClass("bars") || r.fadeOut(), a.removeClass("open"));
      }),
      ...
      $(".form-control").focus(function () {
        ...
        $(".form-control").focusout(function () {
          ...
          e.parents(".form-group").hasClass("form-float")
            ? "" == e.val() && e.parents(".form-line").removeClass("focused")
